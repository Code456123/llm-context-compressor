              ...
              <form onSubmit={handleSignIn} className="space-y-4 font-mono text-xs">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-[10px] text-zinc-400 hover:text-white">Forgot?</a>
                  </div>
                  <div className="relative">
                ...
                <div className="flex items-center justify-between pt-1">
                  <label className="flex items-center gap-2 cursor-pointer select-none text-zinc-400 text-[11px]">
                    <input
                      type="checkbox"
                      checked={rememberMe}
