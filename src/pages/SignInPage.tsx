...
export const SignInPage: React.FC = () => {
  ...
  const [email, setEmail] = useState('admin@contextflow.ai');
        ...
        <div className="space-y-6">
          ...
          <div className="auth-card rounded-2xl p-8 space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 rounded-xl border border-cyan-300/25 bg-[#081427]/85 px-4 py-3 text-xs font-mono text-slate-100 transition-colors duration-200 hover:border-cyan-200/35 hover:bg-[#0B1A2D]"
            >
            ...
            <div className="flex items-center gap-3 text-[10px] font-mono uppercase tracking-wide text-slate-500">
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer select-none text-slate-300 text-[11px]">
                  <input
                    ...
                    className="rounded border-teal-300/20 bg-slate-900 accent-cyan-300"
                  />
